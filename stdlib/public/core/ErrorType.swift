...
extension Error {
  ...
  @_inlineable // FIXME (sil-serialize-all) id:755 gh:762
...
@_inlineable // FIXME (sil-serialize-all) id:950 gh:957
...
/// throws an error.
@_inlineable // FIXME (sil-serialize-all) id:1095 gh:1102
...
@_inlineable // FIXME (sil-serialize-all) id:739 gh:746
...
extension Error {
  @_inlineable // FIXME (sil-serialize-all) id:1625 gh:1632
  public var _code: Int {
    return _getDefaultErrorCode(self)
  }

  @_inlineable // FIXME (sil-serialize-all) id:757 gh:764
...
extension Error where Self: RawRepresentable, Self.RawValue: SignedInteger {
  ...
  @_inlineable // FIXME (sil-serialize-all) id:952 gh:959
  public var _code: Int {
...
extension Error where Self: RawRepresentable, Self.RawValue: UnsignedInteger {
  // The error code of Error with integral raw values is the raw value.
  @_inlineable // FIXME (sil-serialize-all) id:1099 gh:1106
  public var _code: Int {
    return numericCast(self.rawValue)
  }
}

...
> {
  ...
  @_inlineable // FIXME (sil-serialize-all) id:597 gh:604
  @inline(__always)
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:744 gh:751
  @inline(__always)
  public // @testable
  init(objC: ObjC) {
    _sanityCheck(_usesNativeSwiftReferenceCounting(NativeClass.self))
  ...
  @_inlineable // FIXME (sil-serialize-all) id:895 gh:902
  @inline(__always)
  public // @testable
  init(native: Native) {
    _sanityCheck(_usesNativeSwiftReferenceCounting(NativeClass.self))
  ...
  @_inlineable // FIXME (sil-serialize-all) id:579 gh:586
  public // @testable
  var spareBits: Int {
  @inline(__always) get {
  ...
  @_inlineable // FIXME (sil-serialize-all) id:1460 gh:1467
  @inline(__always)
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:599 gh:606
  @inline(__always)
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:747 gh:754
  public // @testable
  var isNative: Bool {
    @inline(__always) get {
  ...
  @_inlineable // FIXME (sil-serialize-all) id:898 gh:905
  @inline(__always)
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:582 gh:589
  public // @testable
  var isObjC: Bool {
    @inline(__always) get {
      return !isNative
  ...
  @_inlineable // FIXME (sil-serialize-all) id:1463 gh:1471
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:602 gh:609
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:809 gh:816
  @inline(__always)
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:901 gh:908
  @inline(__always)
  public // @testable
  ...
  @_inlineable // FIXME (sil-serialize-all) id:585 gh:592
  public // @testable
  ...
  //===--- private --------------------------------------------------------===//
  @_inlineable // FIXME (sil-serialize-all) id:1466 gh:1473
  @_versioned // FIXME (sil-serialize-all) id:605 gh:612

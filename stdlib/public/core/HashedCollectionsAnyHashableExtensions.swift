...
extension Set where Element == AnyHashable {
  @_inlineable // FIXME (sil-serialize-all) id:906 gh:913
  ...
  @_inlineable // FIXME (sil-serialize-all) id:1033 gh:1040
  @discardableResult
  ...
  @_inlineable // FIXME (sil-serialize-all) id:1158 gh:1165
  @discardableResult

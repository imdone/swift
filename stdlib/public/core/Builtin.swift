...
@_inlineable // FIXME (sil-serialize-all) id:812 gh:819
@_versioned
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:1471 gh:1478
@_transparent
public // @testable
...
@_inlineable // FIXME (sil-serialize-all) id:607 gh:614
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:815 gh:822
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:908 gh:915
@_versioned // FIXME (sil-serialize-all) id:591 gh:598
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:1475 gh:1482
@_versioned // FIXME (sil-serialize-all) id:610 gh:617
@_transparent
internal func _unreachable(_ condition: Bool = true) {
  if condition {
    // FIXME: use a parameterized version of Builtin.unreachable when id:818 gh:825
...
@_inlineable // FIXME (sil-serialize-all) id:911 gh:918
@_versioned // FIXME (sil-serialize-all) id:594 gh:601
@_transparent
internal func _conditionallyUnreachable() -> Never {
  Builtin.conditionallyUnreachable()
}

@_inlineable // FIXME (sil-serialize-all) id:1478 gh:1485
@_versioned
...
/// `AnyObject`.
@_inlineable // FIXME (sil-serialize-all) id:613 gh:620
@_versioned
@inline(__always)
...
/// optional references.
@_inlineable // FIXME (sil-serialize-all) id:821 gh:828
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:913 gh:920
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:598 gh:605
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:1483 gh:1490
@_versioned
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:616 gh:623
@_transparent
@_semantics("fastpath")
...
@_inlineable // FIXME (sil-serialize-all) id:823 gh:830
@_transparent
@_semantics("slowpath")
...
/// path.
@_inlineable // FIXME (sil-serialize-all) id:916 gh:923
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:601 gh:608
@_versioned
...
#else
@_inlineable // FIXME (sil-serialize-all) id:1485 gh:1492
@_versioned
@inline(__always)
internal func _usesNativeSwiftReferenceCounting(_ theClass: AnyClass) -> Bool {
  return true
...
@_inlineable // FIXME (sil-serialize-all) id:618 gh:625
@_versioned // FIXME (sil-serialize-all) id:825 gh:832
@_silgen_name("_getSwiftClassInstanceExtents")
internal func getSwiftClassInstanceExtents(_ theClass: AnyClass)
  -> (negative: UInt, positive: UInt)

@_inlineable // FIXME (sil-serialize-all) id:919 gh:926
@_versioned // FIXME (sil-serialize-all) id:604 gh:611
@_silgen_name("_getObjCClassInstanceExtents")
internal func getObjCClassInstanceExtents(_ theClass: AnyClass)
  -> (negative: UInt, positive: UInt)

@_inlineable // FIXME (sil-serialize-all) id:1490 gh:1497
@_versioned // FIXME (sil-serialize-all) id:622 gh:629
@inline(__always)
...
// TODO (<rdar://problem/34837023>): Get rid of superfluous UInt constructor id:827 gh:834
// calls
@_inlineable // FIXME (sil-serialize-all) id:922 gh:930
@_versioned
internal var _objCTaggedPointerBits: UInt {
  @inline(__always) get { return UInt(_swift_BridgeObject_TaggedPointerBits) }
}
@_inlineable // FIXME (sil-serialize-all) id:609 gh:616
@_versioned
...
@_inlineable // FIXME (sil-serialize-all) id:1494 gh:1501
@_versioned
internal var _objectPointerLowSpareBitShift: UInt {
  ...
  s390x)
@_inlineable // FIXME (sil-serialize-all) id:625 gh:631
@_versioned
internal var _objectPointerIsObjCBit: UInt {
    @inline(__always) get { return 0x0000_0002 }
}
#else
@_inlineable // FIXME (sil-serialize-all) id:829 gh:836
@_versioned
internal var _objectPointerIsObjCBit: UInt {
...
@_inlineable // FIXME (sil-serialize-all) id:925 gh:932
@_versioned
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:612 gh:619
@_versioned
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:1497 gh:1504
@_versioned
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:628 gh:635
@_versioned
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:831 gh:838
@inline(__always)
public // @testable
...
@_inlineable // FIXME (sil-serialize-all) id:928 gh:935
@_versioned
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:615 gh:622
@inline(__always)
public // @testable
...
@_inlineable // FIXME (sil-serialize-all) id:1500 gh:1507
@_versioned
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:632 gh:639
@_versioned
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:833 gh:840
@_transparent
public // @testable
...
/// Returns `true` if `object` is uniquely referenced or pinned.
/// This provides sanity checks on top of the Builtin.
@_inlineable // FIXME (sil-serialize-all) id:932 gh:939
@_transparent
public // @testable
...
@_inlineable // FIXME (sil-serialize-all) id:619 gh:626
@_transparent
public // @testable
...
@_inlineable // FIXME (sil-serialize-all) id:1503 gh:1510
@_transparent
public // @testable
...
@_inlineable // FIXME (sil-serialize-all) id:636 gh:643
@_versioned // FIXME (sil-serialize-all) id:835 gh:842
...
@_inlineable // FIXME (sil-serialize-all) id:936 gh:943
@inline(__always)
...
@_inlineable // FIXME (sil-serialize-all) id:621 gh:628
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:1508 gh:1515
@_transparent
...
@_inlineable // FIXME (sil-serialize-all) id:640 gh:647
@_transparent

...
@_inlineable // FIXME (sil-serialize-all) id:1083 gh:1090
@discardableResult
...
///     contents. The default is `Int.max`.
/// - Returns: The instance passed as `value`.
@_inlineable // FIXME (sil-serialize-all) id:723 gh:730
@discardableResult
@_semantics("optimize.sil.specialize.generic.never")
public func dump<T>(
  _ value: T,
...
@_inlineable // FIXME (sil-serialize-all) id:1606 gh:1613
@_versioned // FIXME (sil-serialize-all) id:738 gh:745
@_semantics("optimize.sil.specialize.generic.never")
...
/// that superclass.
@_inlineable // FIXME (sil-serialize-all) id:935 gh:942
@_versioned // FIXME (sil-serialize-all) id:1086 gh:1093
@_semantics("optimize.sil.specialize.generic.never")
